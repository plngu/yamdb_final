# Generated by Django 2.2.16 on 2022-01-26 09:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'регулярный'), ('moderator', 'модератор'), ('admin', 'админ')], default='user', help_text='Роль пользователя', max_length=100, verbose_name='Роль пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmation_code', models.CharField(max_length=1000, verbose_name='Код подтверждения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(blank=True, default=1, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)])),
